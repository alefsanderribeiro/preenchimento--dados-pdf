...
if __name__ == "__main__":
    ...
    # Verificar campos após a assinatura
    #campos_verificados = PdfFormFiller(r"arquivos/modelo_teste.pdf").verificar_campos()
    ...
    print(campos_verificados)
        ...
        # Verificar campos após a assinatura
    #campos_verificados = form_filler.verificar_campos("modelo_teste.pdf")
    #print(campos_verificados)

    # Verificar campos após a assinatura
    #campos_verificados = form_filler.verificar_campos("modelo_teste_preenchido_clicado.pdf")
    #print(campos_verificados)
    
    # Verificar campos após a assinatura
    #campos_verificados = form_filler.verificar_campos("modelo_teste_preenchido_assinado.pdf")
    #print(campos_verificados)